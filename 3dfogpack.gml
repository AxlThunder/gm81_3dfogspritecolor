...
d3d_set_fog(true,argument4,0,0); //start the fog
draw_sprite(argument0,argument1,argument2,argument3); //draw the sprite to fog
d3d_set_fog(false,argument4,0,0); //turn the fog off before it colors anything else
...
d3d_set_fog(true,argument7,0,0); //start the fog
draw_sprite_ext(argument0,argument1,argument2,argument3,argument4,argument5,argument6,c_white,argument8); //draw the sprite to fog
d3d_set_fog(false,argument7,0,0); //turn the fog off before it colors anything else
...
d3d_set_fog(true,argument4,0,0); //start the fog
draw_sprite_ext(argument0,argument1,argument2,argument3,1,1,0,c_white,argument5); //draw the sprite to fog
d3d_set_fog(false,argument4,0,0); //turn the fog off before it colors anything else
...
d3d_set_fog(true,argument7,0,0); //start the fog
draw_sprite_ext(argument0,argument1,argument2,argument3,argument4,argument5,argument6,c_white,argument9); //draw the sprite to fog
d3d_set_fog(false,argument7,0,0); //turn the fog off before it colors anything else
